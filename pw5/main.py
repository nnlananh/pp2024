...
def compress_files():
    with zipfile.ZipFile('C:\\Users\\lanan\\pp2024\\pw5\\students.dat', 'w') as zipf:
        zipf.write('C:\\Users\\lanan\\pp2024\\pw5\\students.txt')
        zipf.write('C:\\Users\\lanan\\pp2024\\pw5\\courses.txt')
        zipf.write('C:\\Users\\lanan\\pp2024\\pw5\\marks.txt')

import os

def decompress_and_load_data():
    if os.path.exists('C:\\Users\\lanan\\pp2024\\pw5\\students.dat'):
        with zipfile.ZipFile('C:\\Users\\lanan\\pp2024\\pw5\\students.dat', 'r') as zipf:
            zipf.extractall()
